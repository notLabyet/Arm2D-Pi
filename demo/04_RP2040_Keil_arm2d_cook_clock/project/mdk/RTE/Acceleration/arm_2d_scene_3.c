...
#if __USER_SCENE3_USE_LMSK__
#   define CMSIS_LOGO_MASK          ARM_LMSK_TILE(SCENE3_LMSK_CMSIS)
#else
...
static void __on_scene3_load(arm_2d_scene_t *ptScene)
{
    user_scene_3_t *ptThis = (user_scene_3_t *)ptScene;
    ARM_2D_UNUSED(ptThis);
    flip_sim_on_load(&s_tFlipSim);
...
static void __after_scene3_switching(arm_2d_scene_t *ptScene)
{
    user_scene_3_t *ptThis = (user_scene_3_t *)ptScene;
    ARM_2D_UNUSED(ptThis);
...
static void __on_scene3_frame_start(arm_2d_scene_t *ptScene)
{
    ...
    ARM_2D_UNUSED(ptThis);
    flip_sim_on_frame_start(&s_tFlipSim);
    if (qmi8658_motion_get_fire_motion(&tMotion)) {
        flip_set_screen_motion_q15(tMotion.gravity_x_q15,
...
static void __on_scene3_frame_complete(arm_2d_scene_t *ptScene)
{
    user_scene_3_t *ptThis = (user_scene_3_t *)ptScene;
    ARM_2D_UNUSED(ptThis);
    flip_sim_on_frame_complete(&s_tFlipSim);
...
static void __before_scene3_switching_out(arm_2d_scene_t *ptScene)
{
    user_scene_3_t *ptThis = (user_scene_3_t *)ptScene;
    ARM_2D_UNUSED(ptThis);
                                        ...
                                        user_scene_3_t *ptThis)
{
    ...
    *ptThis = (user_scene_3_t){
        .use_as__arm_2d_scene_t = {
             ...
             */
            .fnOnLoad       = &__on_scene3_load,
            .fnScene        = &__pfb_draw_scene3_handler,
            .fnAfterSwitch  = &__after_scene3_switching,

            /* if you want to use predefined dirty region list, please uncomment the following code */
            //.ptDirtyRegion  = (arm_2d_region_list_item_t *)s_tDirtyRegions,
            
            //.fnOnBGStart    = &__on_scene3_background_start,         /* deprecated */
            //.fnOnBGComplete = &__on_scene3_background_complete,      /* deprecated */
            .fnOnFrameStart = &__on_scene3_frame_start,
            .fnBeforeSwitchOut = &__before_scene3_switching_out,
    ...
    /* ------------   initialize members of user_scene_3_t begin ---------------*/
    flip_sim_cfg_t tFlipCFG = {
        .tSize = {
            .iWidth = 240,
            .iHeight = 240,
        },
    ...
    int nFlipResult = flip_init();
    assert(0 == nFlipResult);
    ARM_2D_UNUSED(nFlipResult);

    arm_2d_err_t tResult = flip_sim_init(&s_tFlipSim, &tFlipCFG);
    assert(tResult >= 0);
    ARM_2D_UNUSED(tResult);

#if __USER_SCENE3_USE_LMSK__ 
    ARM_LMSK_ITEM_INIT_WITH_ROM(SCENE3_LMSK_CMSIS, c_lmskCMSISLogo, 1881);
#endif

    /* ------------   initialize members of user_scene_3_t end   ---------------*/
