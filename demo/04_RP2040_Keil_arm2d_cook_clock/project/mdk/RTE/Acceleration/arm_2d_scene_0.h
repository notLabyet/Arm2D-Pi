...
#ifndef __USER_SCENE0_ENABLE_3D__
#   define __USER_SCENE0_ENABLE_3D__          0
#endif
...
#define USER_SCENE0_ARC_COUNT              7
/*============================ MACROFIED FUNCTIONS ===========================*/
...
ARM_PRIVATE(
    ...
    bool bUserAllocated;
    user_generic_loader_arc_t tArcLoader[USER_SCENE0_ARC_COUNT];
    user_generic_loader_arc_param_t tArcParam[USER_SCENE0_ARC_COUNT];
    arm_2d_helper_dirty_region_item_t
        tArcDirtyRegionItem[USER_SCENE0_ARC_COUNT];
