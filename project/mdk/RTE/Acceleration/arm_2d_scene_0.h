...
ARM_PRIVATE(
    ...
    uint16_t hwIdleDelayMs;
    uint32_t wIdleWaitStartMs;
    uint8_t chActiveAnim;
    uint8_t chLastAnim;
    bool bIdleWaiting;
    bool bUserAllocated;
    ...
    /* place your public member here */
    arm_2d_helper_film_t tFilmIdle;
    arm_2d_helper_film_t tFilmThinking;
    arm_2d_helper_film_t tFilmWorking;
    arm_2d_helper_film_t tFilmRetrying;
    arm_2d_helper_film_t tFilmDying;
};
