...
#   define __USER_SCENE1_USE_LMSK__       0
#endif
/*============================ MACROFIED FUNCTIONS ===========================*/
...
ARM_PRIVATE(
    ...
    ARM_LMSK_GROUP_DEF(__SCENE1_LMSK_COUNT);
#endif

)
        int16_t target_offset_x;
        int16_t target_offset_y;
	    int16_t offset_x;
		int16_t offset_y;
        int32_t parallax_offset_x_q4;
        int32_t parallax_offset_y_q4;
        int32_t parallax_velocity_x_q4;
        int32_t parallax_velocity_y_q4;
    /* place your public member here */
	    arm_2d_helper_film_t tFilm;
  	    arm_2d_helper_film_t tFilm_mask;  
