...
#ifndef __USER_GENETIC_LOADER_TEMPLATE_H__
#define __USER_GENETIC_LOADER_TEMPLATE_H__
...
#ifdef __fire_sim_IMPLEMENT__
#   undef   __fire_sim_IMPLEMENT__
#   define  __ARM_2D_IMPL__
#elif defined(__fire_sim_INHERIT__)
#   undef   __fire_sim_INHERIT__
 ...
 */
typedef struct fire_sim_t fire_sim_t;
...
#define fire_sim_init(...)                 ARM_2D_ERR_NOT_AVAILABLE
#define fire_sim_depose(...)
#define fire_sim_on_load(...)
#define fire_sim_on_frame_start(...)
#define fire_sim_on_frame_complete(...)
